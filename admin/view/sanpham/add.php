                ...
                <div class="card-body">
                    <form action="index.php?action=addsanpham" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" id="sanpham">
                        </div>

                        <div class="mb-3">
                            <label for="sanpham" class="form-label">Giá sản phẩm</label>
                            <input type="text" class="form-control" name="price" id="sanpham">
                        </div>

                        <div class="mb-3">
                            <label for="sanpham" class="form-label">Mô tả sản phẩm</label>
                            <input type="text" class="form-control" name="description" id="sanpham">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="category_id" id="sanpham">
                        </div>
