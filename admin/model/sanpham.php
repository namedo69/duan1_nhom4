...
function editSanPham($id, $name, $fileName, $description ,$category_id, $image)
{
    if ($fileName == null){
        $sql = "update product set name = '$name', description='$description', category_id='$category_id' where product_id='$id'";
    } else {
