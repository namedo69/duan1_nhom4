...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2024 at 03:18 PM
...
INSERT INTO `bill` (`id`, `client_id`, `status`, `total`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `bill_detail` (`id`, `order_id`, `product_id`, `quantity`, `price`) VALUES
(1, 1, 1, 2, 100.00),
(2, 2, 2, 1, 200.00),
(3, 3, 3, 4, 300.00),
(4, 4, 4, 2, 150.00),
...
(8, 'BEAST COMPLEX III', 99000, 'Đây là nguồn gốc của \'BEASTARS\'. Một thế giới nơi các loài động vật ăn thịt và động vật ăn cỏ cùng tồn tại. Thế giới đầy những cảm xúc đa dạng. Trong thế giới này, vẫn còn vô số câu chuyện cần được kể. Chính vì sự khác biệt, việc đối mặt trở nên khó khăn. Và vì khó khăn, sự cố gắng đối mặt trở nên tàn nhẫn và đẹp đẽ. Tập truyện ngắn thứ ba tuyệt vời của Paru Itagaki.', 'product-2.jpg', 11, 4, '1'),
(26, 'lương chất vcl', 1, '1', 'product-2.jpg', 0, 1, '1'),
(27, '111', 1, '1', '', 0, 1, '1'),
(28, '1', 1, '1', 'product-5.jpg', 0, 1, '1'),
(29, '111', 1, '1', '', 0, 1, '1'),
(30, '111', 1, '1', '', 0, 1, '1'),
(31, 'dcvxcv', 2147483647, 'sakjdhfkasjhdfkjahsdf', '', 0, 1, '1'),
(32, 'dcvxcv', 1, '1', '', 0, 1, '1'),
(33, '1', 1, '1', 'product-2.jpg', 0, 1, '1'),
(34, 'dcvxcv', 1, '1', '', 0, 1, '1'),
(35, '111', 1, '1', '', 0, 1, '1'),
(36, 'dcvxcv', 1, '1', '2024_11_21_20_05_20product-9.jpg', 0, 1, '1'),
(37, '1', 1, '1', '', 0, 1, '1'),
(38, 'dcvxcv', 2147483647, 'sakjdhfkasjhdfkjahsdf', '', 0, 1, '1'),
(39, '1', 2147483647, 'sakjdhfkasjhdfkjahsdf', 'product-1.jpg', 0, 1, '1'),
(40, 'dcvxcv', 2147483647, '1', '', 0, 1, '1'),
(41, 'ncx', 2147483647, '1', 'product-1.jpg', 0, 1, '1'),
(42, 'luong chu ai', 1, 'sfgsdhdfh', '2024_11_21_19_50_01product-7.jpg', 0, 1, '1');
